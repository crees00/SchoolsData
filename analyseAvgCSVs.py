...
def combineIntermediateResultsCSVs(listOfCSVFilenames, outFile=''):
    ...
    for fileName in listOfCSVFilenames[1:]:
        ...
        colsInMain = set(bigDF.columns)
        colsInNew = set(nextDFtoJoin.columns)
        colsToDrop = (colsInMain & colsInNew)
...
listofcsvs = makeCSVlistFromFolderName('paramsearch4SepChosenCols')
outFile = 'fullBashsep4ChosenCols1.csv'
