...
inputDF = pd.read_csv('df6ForModelModifiedImputedNOTNORMALISED.csv')
...
dfWithCats = makeLabelledSubsets(dictOfURNs, 'bbbb','gsbbbs', inputDF, 'bbbbVgsbbbs6NOTNORMALISED.csv')
